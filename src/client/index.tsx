/**
 * Browser half of dsh-step-trace: its page inside Settings.
 *
...
import { StepTracePanel } from './view.js'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, en }), 'dsh-step-trace: dictionaries')
