 ...
 * reports as "loaded without registering 'dsh-step-trace' via __ModuleLoader__.load".
 *
...
await build({
  ...
  banner: {
    ...
    js: 'window.__ModuleLoader__.load({ id: "dsh-step-trace", factory: (require) => {'
